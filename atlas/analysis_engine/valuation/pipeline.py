...
(`cash_flow.evaluate_fcf_yield_relative`, fiscal_epoch_v3) and the three scenario
...
def evaluate_valuation(
    ...
    *,
    ...
    valuation_basis: IssuerValuationBasis | None,
    ...
    `valuation_basis` is the issuer basis the epochs are priced on; without
    one the FCF-yield valuation is withheld, never priced another way.
    """
