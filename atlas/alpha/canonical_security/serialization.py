...
def to_json_dict(security: CanonicalSecurity) -> dict[str, Any]:
    return {
        ...
        "tradingCurrency": security.trading_currency.value if security.trading_currency else None,
...
def from_json_dict(data: dict[str, Any]) -> CanonicalSecurity:
    return CanonicalSecurity(
        ...
        trading_currency=(TradingCurrency(data["tradingCurrency"]) if data.get("tradingCurrency") else None),
...
def _listing_from_dict(data: dict[str, Any]) -> ListingRef:
    return ListingRef(
        ...
        currency=(TradingCurrency(data["currency"]) if data.get("currency") else None),
