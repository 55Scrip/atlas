...
def fundamentals_record(*, period_end: date, identifier: str, company: str = "ASML", **metadata) -> BusinessRecord:
    return _make_record(
        source_kind="annual_report", period_end=period_end, identifier=identifier, company=company, metadata=metadata
    )


def market_record(*, period_end: date, identifier: str, company: str = "ASML", **metadata) -> BusinessRecord:
    return _make_record(
