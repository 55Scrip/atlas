...
| [docs/atlas_reasoning_foundations/README.md](docs/atlas_reasoning_foundations/README.md) | Atlas Reasoning Foundations — ontology-first, pre-implementation ADR track (Reasoning, Judgment, Knowledge — all Final); ontology only, does not govern current runtime behavior; separate from the executable `atlas/core` baseline |
