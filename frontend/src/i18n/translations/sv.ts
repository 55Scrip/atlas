...
export const sv: Record<TranslationKey, string> = {
  ...
  "investmentReasoning.riskBasis.financial": "Grund för förhöjd finansiell risk: {{basis}}.",
  "investmentReasoning.riskBasis.debtIncreased": "total skuld ökade från varje utvärderad period till nästa ({{series}})",
  "investmentReasoning.riskBasis.cashNegative": "det senaste fria kassaflödet var negativt ({{figure}})",
  "investmentReasoning.riskBasis.capitalAllocationWeak": "kapitalallokeringen bedöms som svag",
  "investmentReasoning.riskBasis.alsoValuation": "Värderingsrisken bedöms också som hög.",
  "investmentReasoning.riskBasis.scope": "Bedömningen bygger på redovisade historiska belopp — inte på skuldsättningsgrad, räntetäckning, likviditet eller kreditbetyg.",
  "investmentReasoning.riskBasis.valuationOnly": "Grund för förhöjd finansiell risk: värderingsrisken bedöms som hög — värderingen är hög jämfört med bolagets egen historik. Den finansiella risken i sig bedöms som {{level}}.",
  "investmentReasoning.riskBasis.level.notEvaluated": "inte bedömd",
  "investmentReasoning.riskBasis.level.insufficientInput": "inte möjlig att bedöma",
