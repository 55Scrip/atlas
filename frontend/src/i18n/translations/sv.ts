...
export const sv: Record<TranslationKey, string> = {
  ...
  "dailyBrief.watchingToday.heading": "Det här bevakar Atlas idag",
  "dailyBrief.watchingToday.calm": "Idag ser lugnt ut. Inga schemalagda händelser väntas påverka din portfölj väsentligt.",
