...
export const sv: Record<TranslationKey, string> = {
  ...
  "discovery.everythingElse.caption": "Övriga bolag",
  "discovery.table.companyHeader": "Bolag",
  "discovery.table.decisionHeader": "Beslutsstöd",
  "discovery.table.currentViewHeader": "Nuvarande syn",
  ...
  "discovery.highestOpportunity.heading": "Största möjligheterna",
  "discovery.highestOpportunity.empty": "Ingen kandidat sticker ut som en toppmöjlighet just nu.",
  "discovery.worthReviewing.heading": "Värt att se över",
  "discovery.everythingElse.headingOne": "1 bolag till",
  "discovery.everythingElse.headingOther": "{{count}} bolag till",
