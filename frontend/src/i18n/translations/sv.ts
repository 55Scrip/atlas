...
export const sv: Record<TranslationKey, string> = {
  ...
  "investmentCase.analysis.valuationScenarios.notYet": "Scenariobaserad värdering stöds ännu inte. Atlas utvärderar för närvarande värdering enbart utifrån FCF-avkastning relativt historik.",
