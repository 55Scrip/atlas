...
export const sv: Record<TranslationKey, string> = {
  ...
  // ---------- onboarding (Zero-Effort Portfolio Onboarding) ----------
  "onboarding.title": "Lägg till din portfölj",
  "onboarding.choose.prompt": "Hur vill du lägga till din portfölj?",
  "onboarding.choose.avanza": "Importera från Avanza",
  "onboarding.choose.nordnet": "Importera från Nordnet",
  "onboarding.choose.paste": "Klistra in portfölj",
  "onboarding.choose.csv": "Ladda upp fil",
  "onboarding.choose.manual": "Ange innehav manuellt",
  "onboarding.input.instructionsAvanza":
    "Öppna din portfölj i Avanza, tryck på ⋯ → Exportera, och klistra in tabellen här.",
  "onboarding.input.instructionsNordnet":
    "Öppna din portfölj i Nordnet, exportera dina innehav och klistra in dem här.",
  "onboarding.input.instructionsPaste":
    "Klistra in dina innehav nedan — Atlas identifierar bolagen och räknar ut andelarna automatiskt.",
  "onboarding.input.placeholder": "Microsoft 10 400\nApple 5 190",
  "onboarding.input.continueButton": "Fortsätt",
  "onboarding.input.backButton": "Tillbaka",
  "onboarding.csv.readError": "Kunde inte läsa filen.",
  "onboarding.manual.heading": "Ange dina innehav",
  "onboarding.manual.instructions":
    "Berätta för Atlas vad du äger — bolag, antal aktier och inköpspris. Atlas räknar ut resten.",
  "onboarding.manual.companyLabel": "Bolag",
  "onboarding.manual.quantityLabel": "Antal",
  "onboarding.manual.priceLabel": "Pris",
  "onboarding.manual.addRowButton": "+ Lägg till innehav",
  "onboarding.manual.removeRowButton": "Ta bort",
  "onboarding.manual.noPortfolioYetLink": "Jag har ingen portfölj än",
  "onboarding.manual.continueButton": "Fortsätt",
  "onboarding.scratch.heading": "Börja från grunden",
  "onboarding.scratch.objectiveLabel": "Investeringsmål",
  "onboarding.scratch.horizonLabel": "Investeringshorisont",
  "onboarding.scratch.continueButton": "Fortsätt till portföljen",
  "onboarding.scratch.errors.required": "Både mål och horisont krävs.",
  "onboarding.scratch.errors.saveFailed": "Atlas kunde inte spara just nu. Försök igen.",
  "onboarding.loadingPreview": "Läser din portfölj…",
  "onboarding.confirming": "Importerar din portfölj…",
  "onboarding.review.heading": "Granska",
  "onboarding.review.foundSummary": "Atlas hittade {{count}} innehav.",
  "onboarding.review.resolvedSummary": "{{count}} bekräftades automatiskt",
  "onboarding.review.needsAttentionSummary": "{{count}} behöver din hjälp",
  "onboarding.review.suggestedSummary": "{{count}} matchades med hög säkerhet — bekräfta gärna",
  "onboarding.review.suggestedPrompt": "Atlas tror att det här är {{name}} ({{ticker}}). Stämmer det?",
  ...
  "onboarding.review.excludedSummary": "{{count}} rader kunde inte inkluderas.",
  "onboarding.review.currencyConflict":
    "De här innehaven anger mer än en valuta, så Atlas kan inte räkna ut andelar automatiskt. Gå tillbaka och importera en valuta i taget.",
  "onboarding.review.noHoldingsFound": "Inga innehav hittades i det du angav.",
  "onboarding.review.importButton": "Importera portfölj",
  "onboarding.review.backButton": "Tillbaka",
  "onboarding.review.replaceWarning": "Det här ersätter de innehav som just nu visas i Atlas.",
  "onboarding.review.willSkipNote": "{{count}} innehav du inte löst hoppas över för nu — du kan lägga till dem senare.",
  "onboarding.review.errors.nothingToImport": "Inget att importera än — lös innehaven ovan först.",
  "onboarding.review.errors.submitFailed": "Atlas kunde inte slutföra importen just nu. Försök igen.",
  "onboarding.progress.heading": "Atlas bygger din investeringsarbetsyta.",
  "onboarding.progress.imported": "Portfölj importerad",
  "onboarding.progress.holdingsIdentified": "{{count}} innehav identifierade",
  "onboarding.progress.analyzing": "Analyserar {{name}}…",
  "onboarding.progress.countSummary": "{{done}} av {{total}} bolag analyserade",
  "onboarding.progress.startNow": "Du kan börja använda Atlas nu.",
  "onboarding.progress.remainingNote": "Resterande bolag slutförs automatiskt.",
  "onboarding.progress.goToPortfolio": "Gå till portföljen",
  ...
  "portfolio.empty.step.understand.body": "Se hur din portfölj är uppbyggd, och hur mycket Atlas vet om varje innehav.",
  ...
  "portfolio.cockpit.conviction.insufficient_evidence": "Vet inte än",
  // ---------- Internal Alpha Fix Sprint 1: Analysis Coverage (IA-003) ----------
  "portfolio.cockpit.analysisCoverage.no_coverage": "Inte utvärderat",
  "portfolio.cockpit.analysisCoverage.partial_coverage": "Delvis utvärderat",
  "portfolio.cockpit.analysisCoverage.substantial_coverage": "Utvärderat",
  "portfolio.cockpit.valuation.not_evaluated": "Inte utvärderad",
  "portfolio.cockpit.valuation.insufficient_input": "Vet inte än",
  ...
  "portfolio.cockpit.risk.status.insufficient_input": "Vet inte än",
  "portfolio.cockpit.risk.status.not_applicable": "Ej tillämplig",
  ...
  "portfolio.cockpit.business.insufficient_input": "Vet inte än",
  ...
  "portfolio.cockpit.review.standard_review": "Värt en titt",
  "portfolio.cockpit.review.evidence_review": "Mer underlag väntas",
  "portfolio.cockpit.review.priority_review": "Bör granskas snart",
  ...
  "portfolio.pulse.coverageLabel": "Analysdjup",
  "portfolio.pulse.coverageValue": "{{covered}} av {{total}} utvärderade",
  ...
  // ---------- Position Editor v1 ----------
  "portfolio.editor.open": "Ändra position",
  "portfolio.editor.title": "{{ticker}} — hypotetisk position",
  "portfolio.editor.currentPosition": "Nuvarande position",
  "portfolio.editor.activeHypothetical": "Hypotetisk position",
  "portfolio.editor.targetValue": "Målvärde för positionen",
  "portfolio.editor.targetValueAria": "Målvärde för positionen i {{ticker}}",
  "portfolio.editor.setToZero": "Ta bort ur simuleringen",
  "portfolio.editor.restore": "Återställ nuvarande position",
  "portfolio.editor.impactHeading": "Portföljpåverkan",
  "portfolio.editor.positionValue": "Positionens värde",
  "portfolio.editor.weight": "Portföljandel",
  "portfolio.editor.unallocated": "Oallokerat kapital",
  "portfolio.editor.capitalLimit": "Begränsas av tillgängligt oallokerat kapital ({{available}}).",
  "portfolio.editor.apply": "Tillämpa i simuleringen",
  ...
  "portfolio.cockpitTable.businessHeader": "Verksamhet",
  "portfolio.cockpitTable.investmentHeader": "Investering",
  "portfolio.cockpitTable.riskHeader": "Risk",
  "portfolio.cockpitTable.valuationHeader": "Värdering",
  "portfolio.cockpitTable.forwardHeader": "Framåt",
  "portfolio.cockpitTable.fitHeader": "Passform",
  "portfolio.cockpitTable.link.atlas": "Öppna {{ticker}} — Atlas slutsats",
  "portfolio.cockpitTable.link.business": "Öppna {{ticker}} — analys av bolaget",
  "portfolio.cockpitTable.link.investment": "Öppna {{ticker}} — Atlas slutsats",
  "portfolio.cockpitTable.link.risk": "Öppna {{ticker}} — riskanalys",
  "portfolio.cockpitTable.link.valuation": "Öppna {{ticker}} — värderingsanalys",
  "portfolio.cockpitTable.link.forward": "Öppna {{ticker}} — framåtblick",
  "portfolio.cockpitTable.link.fit": "Öppna {{ticker}} — portföljpassform",
  "portfolio.cockpitTable.forward.verified": "Verifierat",
  "portfolio.cockpitTable.forward.countOne": "{{count}} mått",
  "portfolio.cockpitTable.forward.countOther": "{{count}} mått",
  "portfolio.cockpitTable.none": "—",
  "portfolio.cockpitTable.notAssessed": "Inte bedömd",
  "portfolio.cockpitTable.limitedEvidence": "Begränsat underlag",
  ...
  "portfolio.holdingsTable.recommendationHeader": "Rekommendation",
  "portfolio.holdingsTable.largestRiskHeader": "Största risk",
  "portfolio.holdingsTable.riskCell": "{{category}}: {{status}}",
  "portfolio.holdingsTable.notAssessed": "Ej bedömt",
  ...
  "portfolio.holdingsTable.coverage.substantial_coverage": "Utvärderat",
  "portfolio.holdingsTable.coverage.partial_coverage": "Delvis utvärderat",
  "portfolio.holdingsTable.coverage.no_coverage": "Inte utvärderat",
  ...
  "portfolio.coverageActive.title": "Analysdjup",
  "portfolio.coverageActive.body": "{{covered}} av dina {{total}} unika innehav är fullt utvärderade.",
  ...
  "portfolio.intelligence.confidence.not_applicable": "Vet inte än",
  ...
  "dataFreshness.status.waitingForNewData": "Inget nytt att rapportera.",
  "dataFreshness.status.waitingForAnalysis": "Ny information hittad — analyseras snart.",
  "dataFreshness.status.monitoringFailed": "Uppdatering misslyckades.",
  "dataFreshness.status.noDataSource": "Ingen källa till ny information än.",
  ...
  "investmentCase.ratings.tier.weak": "Svag",
  "investmentCase.ratings.tier.poor": "Dålig",
  "investmentCase.ratings.missing": "Inte betygsatt än",
  "investmentCase.ratings.notApplicable": "Inte tillämpligt",
  "investmentCase.ratings.qualitative.low": "Låg",
  ...
  "investmentCase.reasoning.valuation.caveat.singleLowEdge": "FY{{year}} utgör ensamt intervallets nedre ände; dagens FCF-avkastning ligger under alla övriga tidigare år.",
  "investmentCase.reasoning.valuation.caveat.singleHighEdge": "FY{{year}} utgör ensamt intervallets övre ände; dagens FCF-avkastning ligger över alla övriga tidigare år.",
  "investmentCase.reasoning.valuation.caveat.minimumHistory": "Vilar på minimikravet {{count}} tidigare räkenskapsår.",
  "investmentCase.reasoning.valuation.caveat.cashFlowBelowRecent": "Periodens fria kassaflöde är lägre än vart och ett av de {{count}} senast jämförda åren.",
  "investmentCase.reasoning.valuation.caveat.cashFlowAboveRecent": "Periodens fria kassaflöde är högre än vart och ett av de {{count}} senast jämförda åren.",
  "investmentCase.reasoning.valuation.caveat.nearBoundary": "Närmare gränsen till {{classification}} än historikens typiska förändring mellan år.",
  "investmentCase.reasoning.valuation.caveat.shareBasisNotExact": "Vissa tidigare perioder prissätts på en likvärdig eller avgränsad aktiebas, inte en exakt rapporterad.",
  "investmentCase.reasoning.valuation.caveat.capitalIntensityAbove": "Investeringarna tar en större andel av omsättningen än något jämfört år.",
  "investmentCase.reasoning.showEvidence": "Visa underlag",
  ...
  "investmentCase.analysis.valuation.shareCountExact": "Varje tidigare marknadsvärde bygger på periodens eget rapporterade antal aktier.",
  "investmentCase.analysis.valuation.shareCountEquivalent": "Varje tidigare marknadsvärde bygger på periodens egen aktiebas; för vissa perioder prissätts ett aktieslag genom inlämnad ekonomisk likvärdighet i stället för sin egen notering.",
  "investmentCase.analysis.valuation.shareCountBounded": "Varje tidigare marknadsvärde bygger på periodens egen aktiebas; för vissa perioder är en del av den ett intervall härlett ur underlaget, och jämförelsen håller i intervallets båda ändar.",
  "investmentCase.analysis.valuation.boundaryDistance": "{{percent}} från att klassas som {{classification}}.",
  "investmentCase.analysis.valuation.rangeEdges": "Intervallets ändar: FY{{lowYear}} på {{low}} och FY{{highYear}} på {{high}}; näst lägst FY{{secondLowYear}} på {{secondLow}}.",
  "investmentCase.analysis.valuation.corroboration": "{{below}} av {{count}} tidigare år ligger på eller under dagens avkastning {{current}}.",
  "investmentCase.analysis.valuation.dispersion": "Tidigare års FCF-avkastning låg mellan {{low}} och {{high}}, median {{median}}.",
  "investmentCase.analysis.valuation.cashFlowVsHistory": "Periodens fria kassaflöde är {{versusPrior}} av förra årets och {{versusRecent}} av medianen för de {{count}} senast jämförda åren.",
  "investmentCase.analysis.valuation.capitalIntensity": "Investeringarna utgör {{current}} av omsättningen, mot en median på {{median}} under {{count}} jämförda år ({{low}} till {{high}}).",
  ...
  "investmentCase.analysis.risk.gap.missingDebt": "Uppgift om total skuld saknas.",
  "investmentCase.analysis.risk.gap.industryUnknown": "Bolagets bransch är okänd.",
  "investmentCase.analysis.risk.gap.staleFinancialStatements": "Senaste jämförbara räkenskapsår är för gammalt.",
  "investmentCase.analysis.risk.gap.noAlignedPeriod": "Skuld och kassaflöde finns inte för samma räkenskapsår.",
  "investmentCase.analysis.risk.gap.missingOperatingCashFlow": "Kassaflödet från rörelsen kan inte beräknas — fritt kassaflöde eller investeringar saknas.",
  ...
  "decisionSupport.badge.insufficient_evidence": "Vet inte än",
  ...
  "investmentCase.observations.technicalTransparencyLabel": "Teknisk transparens — råa observationer, underlag och resonemangsposter",
  ...
  "investmentCase.header.valuationVsHistoryLabel": "Värdering jämfört med egen historik",
  ...
  "investmentCase.intelligence.missingEvidence.observationWithoutEvidence":
    "En observation saknar underlag.",
  ...
  "investmentCase.intelligence.openQuestions.decisionWithoutLinkedObservation":
    "Vad låg bakom det här beslutet?",
  ...
  "history.analytical.loadOlder": "Ladda äldre analyser",
  "history.analytical.loadingOlder": "Laddar äldre analyser…",
  "history.analytical.loadOlderFailed": "Äldre analyser kunde inte laddas ({{message}}). Posterna ovan påverkas inte.",
  "history.analytical.evidence.notStored": "Detaljerad värderingsevidens sparades inte för den här analysen.",
  "history.analytical.evidence.yieldAtAnalysis": "FCF-avkastning vid analysen: {{yield}}.",
  "history.analytical.evidence.comparedWith": "Jämfördes med {{count}} tidigare räkenskapsår som var registrerade då.",
  "history.analytical.evidence.withheld": "Inga räkenskapsår var jämförbara då; Värderingsstöd var {{support}}.",
  "history.analytical.evidence.singleLowEdge": "FY{{year}} utgjorde intervallets nedre ände. Vid analysen låg FCF-avkastningen under alla övriga sparade tidigare år.",
  "history.analytical.evidence.singleHighEdge": "FY{{year}} utgjorde intervallets övre ände. Vid analysen låg FCF-avkastningen över alla övriga sparade tidigare år.",
  "history.analytical.evidence.showDetail": "Värderingsevidens vid analysen",
  "history.analytical.evidence.range": "Intervallets ändar vid analysen: FY{{lowYear}} på {{low}} och FY{{highYear}} på {{high}}.",
  "history.analytical.evidence.corroboration": "{{below}} av {{count}} registrerade tidigare år låg på eller under avkastningen vid analysen.",
  "history.analytical.evidence.support": "Värderingsstöd vid analysen: {{support}}.",
  "history.analytical.evidence.methodology": "Metod som användes: {{methodology}}.",
  "history.analytical.evidence.tableCaption": "Räkenskapsår som jämfördes vid analysen",
  "history.analytical.evidence.columnYear": "Räkenskapsår",
  "history.analytical.evidence.columnYield": "FCF-avkastning",
  "history.analytical.evidence.columnBasis": "Aktiebas",
  ...
  "investmentCase.whatWouldChange.improvedGrowthEvidence": "Belägg för att tillväxten stabiliserats eller förbättrats",
  "investmentCase.whatWouldChange.improvedCapitalAllocationEvidence": "Belägg för förbättrad kapitalallokering",
  "investmentCase.whatWouldChange.lowerValuation": "En väsentligt lägre värdering",
  "investmentCase.whatWouldChange.noCredibleTriggerIdentified": "Atlas har inte identifierat något specifikt villkor som skulle ändra den här bedömningen.",
  "investmentCase.drivers.heading": "Varför Atlas tycker så",
  ...
  "investmentCase.reasoning.financialHealth.moderate":
    "Finansiell risk är måttlig — skulden är märkbar i förhållande till kassaflödet från rörelsen; värd att bevaka.",
  "investmentCase.reasoning.financialHealth.high": "Finansiell risk är hög och kräver uppmärksamhet.",
  "investmentCase.reasoning.financialHealth.notApplicable": "Atlas generella mått för skuld och kassaflöde används inte för denna typ av bolag.",
  ...
  "dailyBrief.sinceLastVisit.heading": "Sedan ditt senaste besök",
  "dailyBrief.sinceLastVisit.onboardingCalm": "Atlas har slutfört sin första genomgång. Inga förändringar har skett sedan din portfölj analyserades.",
  "dailyBrief.sinceLastVisit.empty": "Allt är under kontroll. Inget har förändrats sedan ditt senaste besök.",
  "dailyBrief.sinceLastVisit.unavailable": "Senaste förändringarna är inte tillgängliga just nu.",
  "dailyBrief.agenda.unavailable": "Atlas kunde inte sammanställa dagens genomgång. Försök att uppdatera sidan.",
  "dailyBrief.scheduledEvents.notTracked": "Atlas följer ännu inte schemalagda bolagshändelser, så den här genomgången kan inte säga vad som väntar idag.",
  "dailyBrief.sinceLastVisit.newLabel": "Nytt",
  "dailyBrief.sinceLastVisit.moreForCompanyOne": "+1 uppdatering till för {{ticker}} →",
  "dailyBrief.sinceLastVisit.moreForCompanyOther": "+{{count}} uppdateringar till för {{ticker}} →",
  ...
  "dailyBriefAgenda.collapsed.headingOne": "1 punkt till",
  "dailyBriefAgenda.collapsed.headingOther": "{{count}} punkter till",
  ...
  "dailyBriefAgenda.reasonFact.concentration.elevatedConcentration": "förhöjd koncentration i det här innehavet",
  ...
  "dailyBriefAgenda.reasonFact.managementCredibility.guidanceRevisedDownward": "prognosen har reviderats ner",
  ...
  "dailyBriefAgenda.reasonFact.executiveChange.role.cfo": "finanschef",
  "dailyBriefAgenda.reasonFact.executiveChange.role.coo": "driftschef",
  "dailyBriefAgenda.reasonFact.executiveChange.role.chair": "styrelseordförande",
  "dailyBriefAgenda.reasonFact.executiveChange.role.executiveChair": "verkställande styrelseordförande",
  "dailyBriefAgenda.reasonFact.executiveChange.role.president": "koncernchef",
  "dailyBriefAgenda.reasonFact.executiveChange.role.cto": "teknikchef",
  "dailyBriefAgenda.reasonFact.executiveChange.role.cio": "it-chef",
  "dailyBriefAgenda.reasonFact.executiveChange.role.generalCounsel": "chefsjurist",
  "dailyBriefAgenda.reasonFact.executiveChange.role.boardDirector": "styrelseledamot",
  "dailyBriefAgenda.reasonFact.executiveChange.role.otherExecutive": "ledande befattningshavare",
  "dailyBriefAgenda.reasonFact.executiveChange.event.appointment": "tillträdde",
  "dailyBriefAgenda.reasonFact.executiveChange.event.departure": "lämnade rollen",
  "dailyBriefAgenda.reasonFact.executiveChange.event.resignation": "avgick",
  "dailyBriefAgenda.reasonFact.executiveChange.event.retirement": "gick i pension",
  "dailyBriefAgenda.reasonFact.executiveChange.event.termination": "fick lämna sin roll",
  "dailyBriefAgenda.reasonFact.executiveChange.event.promotion": "befordrades",
  "dailyBriefAgenda.reasonFact.executiveChange.event.interimAppointment": "tillträdde tillfälligt",
  "dailyBriefAgenda.reasonFact.executiveChange.event.permanentAppointment": "tillträdde permanent",
  "dailyBriefAgenda.reasonFact.executiveChange.event.boardAppointment": "valdes in i styrelsen",
  "dailyBriefAgenda.reasonFact.executiveChange.event.boardDeparture": "lämnade styrelsen",
  "dailyBriefAgenda.reasonFact.executiveChange.event.roleChange": "bytte roll",
  ...
  "discovery.candidates.loadError": "Atlas kunde inte läsa in dina rankade kandidater. Försök att uppdatera sidan.",
  "discovery.candidates.loading": "Läser in bolagen som Atlas har analyserat…",
  "discovery.candidates.empty": "Atlas har inga kandidater att visa. Varje bolag som analyserats är ett du redan äger eller redan bevakar.",
  "discovery.candidates.universeOne": "1 bolag som Atlas har analyserat och som du varken äger eller bevakar.",
  "discovery.candidates.universeOther": "{{count}} bolag som Atlas har analyserat och som du varken äger eller bevakar.",
  "discovery.table.companyHeader": "Bolag",
  "discovery.table.decisionHeader": "Beslutsstöd",
  "discovery.table.coverageHeader": "Analysdjup",
  "discovery.table.fitHeader": "Passform",
  "discovery.table.notAssessed": "Ej bedömt",
  "discovery.table.rowAriaLabel": "Öppna investeringscaset för {{ticker}}",
  "discovery.search.heading": "Sök efter ett bolag",
  "discovery.search.explanation": "Sökningen är inte rankad: den slår upp vilket noterat bolag som helst på ticker eller namn, oavsett om Atlas har analyserat det.",
  "discovery.search.clear": "Rensa",
  "discovery.search.inCandidates": "Analyserad — finns bland kandidaterna ovan",
  "discovery.card.openingCase": "Öppnar investeringscaset för {{ticker}}…",
  "discovery.notConcluded.heading": "Ingen slutsats ännu",
  "discovery.entrySupported.heading": "Atlas stöder en ny position",
  "discovery.entrySupported.empty": "Inget av dessa bolag har just nu Atlas stöd för en ny position.",
  "discovery.notConcluded.explanation": "Atlas har studerat dessa men har inte kommit fram till någon slutsats om att gå in. Din bedömning.",
  "discovery.notSupported.headingOne": "1 bolag där Atlas inte stöder att gå in",
  "discovery.notSupported.headingOther": "{{count}} bolag där Atlas inte stöder att gå in",
  "discovery.notSupported.caption": "Bolag där Atlas inte stöder att gå in",
  ...
  // ---------- portfolio import (endast länketikett; se onboarding.* för flödet) ----------
  ...
  "companyWorkspace.evidence.analysisCoverageLabel": "Analysdjup",
  ...
  "watchlist.description": "Atlas bevakar dessa bolag kontinuerligt åt dig, tills du köper eller tar bort dem.",
  ...
  "watchlist.empty.body": "Lägg till ett bolag för att Atlas ska börja bevaka det. Atlas bygger automatiskt ett Investeringscase för det.",
  "watchlist.empty.cta": "+ Lägg till ditt första bolag",
  "watchlist.table.companyHeader": "Bolag",
  "watchlist.table.monitoringSinceHeader": "Bevakas sedan",
  "watchlist.table.waitingForHeader": "Väntar på",
  ...
  "watchlist.table.notAssessed": "Ej bedömt",
  ...
  "coverage.dimension.insufficientEvidence": "Vet inte än",
  ...
  "coverage.panel.heading": "Analysdjup",
  "coverage.panel.overallCoverageLabel": "Totalt",
  ...
  "coverage.badge.label": "Analysdjup",
  "coverage.portfolio.columnLabel": "Analysdjup",
  "coverage.portfolio.sortLabel": "Analysdjup",
  "coverage.discovery.badgeLabel": "Analysdjup",
  ...
  "stance.reason.confidenceVeryLimited": "Atlas har utvärderat mycket få av dimensionerna i den här analysen.",
  "stance.reason.confidenceLimited": "Atlas har bara utvärderat en begränsad del av den här analysen.",
  "stance.reason.confidenceModerate": "Atlas har utvärderat mycket, men inte allt, i den här analysen.",
  ...
  "stance.notYetEvaluatedByAtlasLabel": "Det här utvärderar Atlas inte ännu, för något bolag:",
  ...
  "evidenceTimeline.category.coverageChanged": "Analysdjup",
  ...
  "monitoring.status.changedReviewSuggested": "En förändring har upptäckts.",
  "monitoring.status.changedHighImportance": "En betydande förändring.",
  ...
  "monitoring.freshness.upToDate": "Baserat på Atlas senaste kontroll {{time}}.",
  "monitoring.freshness.pending": "Baserat på Atlas senaste kontroll {{time}}. Nyare information kanske ännu inte återspeglas.",
  ...
  "monitoring.changeFeed.unavailable": "Förändringar är inte tillgängliga just nu.",
  "monitoring.changeFeed.materialityMaterial": "Väsentlig",
  "monitoring.changeFeed.materialityMinor": "Mindre",
  "monitoring.changeFeed.sourceEvidenceTimeline": "från nytt underlag",
  "monitoring.changeFeed.sourceChangeIntelligence": "från Atlas analys av caset",
  "monitoring.changeFeed.sourceCaseCondition": "via ditt villkor",
  "monitoring.changeFeed.unavailableCountOne": "1 bolag har ännu inte kontrollerats för förändringar.",
  "monitoring.changeFeed.unavailableCountOther": "{{count}} bolag har ännu inte kontrollerats för förändringar.",
  "monitoring.changeFeed.viewEventsOne": "Visa 1 förändring →",
  "monitoring.changeFeed.viewEventsOther": "Visa {{count}} förändringar →",
  ...
  "decisionReadiness.blocker.monitoringFailed": "Den senaste kontrollen slutfördes inte.",
  ...
  "decisionReadiness.reason.monitoringCurrent": "Atlas senaste kontroll är aktuell.",
  ...
  "investmentReasoning.heading": "Vad Atlas ser",
  "investmentReasoning.state.withheld": "Atlas stöder ännu ingen riktad rekommendation.",
  "investmentReasoning.state.directional": "Atlas slutsats: {{action}}.",
  "investmentReasoning.row.supports": "Talar för",
  "investmentReasoning.row.opposes": "Talar emot",
  "investmentReasoning.row.indicatesFor": "Underlaget talar för",
  ...
  "investmentReasoning.reason.growthModerate": "Måttlig tillväxt",
  "investmentReasoning.reason.growthWeak": "Svag tillväxt",
  "investmentReasoning.reason.capitalAllocationStrong": "Stark kapitalallokering",
  "investmentReasoning.reason.capitalAllocationModerate": "Måttlig kapitalallokering",
  "investmentReasoning.reason.capitalAllocationWeak": "Svag kapitalallokering",
  "investmentReasoning.reason.valuationUndervalued": "Lågt värderad",
  "investmentReasoning.reason.valuationFairlyValued": "Rimligt värderad",
  "investmentReasoning.reason.valuationExpensive": "Högt värderad",
  "investmentReasoning.reason.valuationSupported": "Värderingen har stöd",
  "investmentReasoning.reason.valuationNotSupported": "Värderingen saknar stöd",
  "investmentReasoning.reason.financialRiskElevated": "Förhöjd finansiell risk",
  "investmentReasoning.reason.financialRiskNotElevated": "Ingen förhöjd finansiell risk",
  "investmentReasoning.engine.growth": "tillväxt",
  "investmentReasoning.engine.capitalAllocation": "kapitalallokering",
  "investmentReasoning.engine.valuation": "värdering",
  "investmentReasoning.engine.valuationSupport": "värderingsstöd",
  ...
  "investmentReasoning.trigger.improvedCapitalAllocationEvidence": "Bättre underlag för kapitalallokering",
  "investmentReasoning.trigger.lowerValuation": "Lägre värdering",
  "investmentReasoning.trigger.financialRiskBecomesElevated": "Om den finansiella risken stiger",
  "investmentReasoning.trigger.valuationBecomesExpensive": "Om värderingen blir hög",
  "investmentReasoning.trigger.valuationSupportLost": "Om värderingsstödet faller bort",
  "investmentReasoning.trigger.growthDeteriorates": "Om tillväxten försämras",
  "investmentReasoning.trigger.capitalAllocationDeteriorates": "Om kapitalallokeringen försämras",
  "investmentReasoning.trigger.noCredibleTrigger": "Ingen tydlig utlösande faktor identifierad",
  "investmentReasoning.row.forwardContext": "Framåtblickande underlag",
  "investmentReasoning.forward.subject.revenue": "intäkter",
  "investmentReasoning.forward.subject.adjustedEbitda": "ett EBITDA-mått",
  "investmentReasoning.forward.subject.freeCashFlow": "ett kassaflödesmått",
  "investmentReasoning.forward.subject.capitalExpenditure": "investeringar",
  "investmentReasoning.forward.subject.managementDefined": " (ledningens definition)",
  "investmentReasoning.forward.guidance.reaffirmed": "Guidning {{horizon}} för {{measure}} oförändrad: {{value}}",
  "investmentReasoning.forward.guidance.raised": "Guidning {{horizon}} för {{measure}} höjd till {{value}} (från {{prior}})",
  "investmentReasoning.forward.guidance.lowered": "Guidning {{horizon}} för {{measure}} sänkt till {{value}} (från {{prior}})",
  "investmentReasoning.forward.guidance.priorUnknown": "en tidigare nivå som källorna anger olika",
  "investmentReasoning.forward.guidance.revisionCount": "{{count}} verifierade revideringar",
  "investmentReasoning.forward.horizon.fiscalYear": "räkenskapsåret {{year}}",
  "investmentReasoning.forward.horizon.calendarYear": "kalenderåret {{year}}",
  "investmentReasoning.forward.horizon.year": "{{year}}",
  "investmentReasoning.forward.volume.single": "Kontrakterad kundvolym: {{customer}} — {{details}}",
  "investmentReasoning.forward.volume.multiple": "Kontrakterad kundvolym som nämner {{names}} i {{count}} källobservationer ({{periods}}) — samma avtal kan förekomma i flera",
  "investmentReasoning.forward.volume.and": " och ",
  "investmentReasoning.forward.volume.term": ", löptid {{years}} år",
  "investmentReasoning.forward.volume.deliveryFrom": ", leveranser från {{years}}",
  "investmentReasoning.forward.volume.unnamedCustomer": "en ej namngiven kund",
  "investmentReasoning.forward.volume.statedTerms": "; angiven löptid: {{terms}} år",
  "investmentReasoning.forward.unknown.allEconomics": "Avtalspris samt bidrag till intäkter, resultat och kassaflöde är inte fastställda",
  "investmentReasoning.forward.unknown.price": "Avtalspris inte fastställt",
  "investmentReasoning.forward.unknown.revenueContribution": "Bidrag till intäkter inte fastställt",
  "investmentReasoning.forward.unknown.earningsContribution": "Bidrag till resultat inte fastställt",
  "investmentReasoning.forward.unknown.cashFlowContribution": "Bidrag till kassaflöde inte fastställt",
  "investmentReasoning.riskBasis.debtBurdenHigh": "Förhöjd finansiell risk: total skuld motsvarar {{multiple}} kassaflödet från rörelsen ({{period}}).",
  "investmentReasoning.riskBasis.operatingCashFlowNegative": "Förhöjd finansiell risk: kassaflödet från rörelsen var negativt ({{period}}: {{value}}) — verksamheten förbrukade kassa.",
  "investmentReasoning.riskBasis.operatingCashFlowZero": "Förhöjd finansiell risk: rörelsen genererade inget kassaflöde ({{period}}).",
  ...
  "investmentReasoning.riskBasis.level.notEvaluated": "inte bedömd",
  "investmentReasoning.riskBasis.level.insufficientInput": "kunde inte bedömas",
  "investmentReasoning.riskBasis.level.notApplicable": "bedöms inte för denna typ av bolag",
  ...
  "investmentReasoning.valuationBasis.shareBasis": "Tidigare marknadsvärden bygger på varje periods egen aktiebas, inte dagens.",
  ...
  "decisionPath.progressKind.coverage": "Analysdjup",
  ...
  "portfolioDecision.category.requiresReview": "Bör ses över",
