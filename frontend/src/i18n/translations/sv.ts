...
export const sv: Record<TranslationKey, string> = {
  ...
  "dailyBriefAgenda.summary.attentionCountOther": "{{count}} saker behöver din uppmärksamhet idag.",
  ...
  "discovery.card.tension.stanceNegativeFitPositive": "Det här gäller enbart portföljpassformen — Atlas flaggade separat en oro i själva bolaget.",
  "discovery.card.tension.stancePositiveFitNegative": "Atlas syn på bolaget har stärkts, men det skulle passa din portfölj dåligt.",
