...
export const en = {
  ...
  "onboarding.title": "Add your portfolio",
  "onboarding.choose.prompt": "How would you like to add your portfolio?",
  "onboarding.choose.avanza": "Import from Avanza",
  "onboarding.choose.nordnet": "Import from Nordnet",
  "onboarding.choose.paste": "Paste portfolio",
  "onboarding.choose.csv": "Upload file",
  "onboarding.choose.manual": "Enter holdings manually",
  "onboarding.input.instructionsAvanza":
    "In Avanza, open your portfolio, tap ⋯ → Export, then paste the table here.",
  "onboarding.input.instructionsNordnet":
    "In Nordnet, open your portfolio, export your holdings, then paste them here.",
  "onboarding.input.instructionsPaste":
    "Paste your holdings below — Atlas will identify companies and calculate weights automatically.",
  "onboarding.input.placeholder": "Microsoft 10 400\nApple 5 190",
  "onboarding.input.continueButton": "Continue",
  "onboarding.input.backButton": "Back",
  "onboarding.csv.readError": "Could not read that file.",
  "onboarding.manual.heading": "Enter your holdings",
  "onboarding.manual.instructions":
    "Tell Atlas what you own — company, number of shares, and purchase price. Atlas calculates everything else.",
  "onboarding.manual.companyLabel": "Company",
  "onboarding.manual.quantityLabel": "Quantity",
  "onboarding.manual.priceLabel": "Price",
  "onboarding.manual.addRowButton": "+ Add holding",
  "onboarding.manual.removeRowButton": "Remove",
  "onboarding.manual.noPortfolioYetLink": "I don't have a portfolio yet",
  "onboarding.manual.continueButton": "Continue",
  "onboarding.scratch.heading": "Starting from scratch",
  "onboarding.scratch.objectiveLabel": "Investment objective",
  "onboarding.scratch.horizonLabel": "Investment horizon",
  "onboarding.scratch.continueButton": "Continue to Portfolio",
  "onboarding.scratch.errors.required": "Objective and horizon are both required.",
  "onboarding.scratch.errors.saveFailed": "Atlas couldn't save this right now. Please try again.",
  "onboarding.loadingPreview": "Reading your portfolio…",
  "onboarding.confirming": "Importing your portfolio…",
  "onboarding.review.heading": "Review",
  "onboarding.review.foundSummary": "Atlas found {{count}} holdings.",
  "onboarding.review.resolvedSummary": "{{count}} resolved automatically",
  "onboarding.review.needsAttentionSummary": "{{count}} need your help",
  "onboarding.review.suggestedSummary": "{{count}} matched with high confidence — please confirm",
  "onboarding.review.suggestedPrompt": "Atlas believes this is {{name}} ({{ticker}}). Is that correct?",
  ...
  "onboarding.review.excludedSummary": "{{count}} lines couldn't be included.",
  "onboarding.review.currencyConflict":
    "These holdings report more than one currency, so Atlas can't calculate weights automatically. Go back and import one currency at a time.",
  "onboarding.review.noHoldingsFound": "No holdings found in what you provided.",
  "onboarding.review.importButton": "Import Portfolio",
  "onboarding.review.backButton": "Back",
  "onboarding.review.replaceWarning": "This will replace the holdings currently shown in Atlas.",
  "onboarding.review.willSkipNote": "{{count}} holdings you haven't resolved will be skipped for now — you can add them later.",
  "onboarding.review.errors.nothingToImport": "Nothing to import yet — resolve the holdings above first.",
  "onboarding.review.errors.submitFailed": "Atlas couldn't complete this import right now. Please try again.",
  "onboarding.progress.heading": "Atlas is building your investment workspace.",
  "onboarding.progress.imported": "Portfolio imported",
  "onboarding.progress.holdingsIdentified": "{{count}} holdings identified",
  "onboarding.progress.analyzing": "Analyzing {{name}}…",
  "onboarding.progress.countSummary": "{{done}} of {{total}} companies analyzed",
  "onboarding.progress.startNow": "You can start using Atlas now.",
  "onboarding.progress.remainingNote": "The remaining companies will finish automatically.",
  "onboarding.progress.goToPortfolio": "Go to Portfolio",
  ...
  "portfolio.cockpit.risk.status.not_applicable": "Not applicable",
  ...
  "portfolio.holdingsTable.recommendationHeader": "Recommendation",
  "portfolio.holdingsTable.largestRiskHeader": "Largest risk",
  "portfolio.holdingsTable.riskCell": "{{category}}: {{status}}",
  "portfolio.holdingsTable.notAssessed": "Not assessed",
  ...
  "investmentCase.ratings.horizon.label": "Sensitivity horizon",
  "investmentCase.ratings.horizon.years": "{{years}} years",
  "investmentCase.ratings.horizon.sensitivityCaption": "Not a forecast",
  ...
  "investmentCase.reasoning.valuation.caveat.singleLowEdge": "FY{{year}} alone forms the low end of the historical range; today's FCF yield is below every other prior year.",
  "investmentCase.reasoning.valuation.caveat.singleHighEdge": "FY{{year}} alone forms the high end of the historical range; today's FCF yield is above every other prior year.",
  "investmentCase.reasoning.valuation.caveat.minimumHistory": "Rests on the minimum of {{count}} prior fiscal years.",
  "investmentCase.reasoning.valuation.caveat.cashFlowBelowRecent": "This period's free cash flow is below every one of the {{count}} most recent compared years.",
  "investmentCase.reasoning.valuation.caveat.cashFlowAboveRecent": "This period's free cash flow is above every one of the {{count}} most recent compared years.",
  "investmentCase.reasoning.valuation.caveat.nearBoundary": "Nearer the {{classification}} boundary than this history's typical year-to-year move.",
  "investmentCase.reasoning.valuation.caveat.shareBasisNotExact": "Some earlier periods are priced on an equivalent or bounded share basis, not an exactly reported one.",
  "investmentCase.reasoning.valuation.caveat.capitalIntensityAbove": "Capital expenditure takes a larger share of revenue than in any compared year.",
  "investmentCase.reasoning.showEvidence": "Show evidence",
  ...
  "investmentCase.analysis.valuation.gap.insufficientHistoricalValuationPeriods":
    "Too few earlier fiscal years for valuation to affect the recommendation.",
  "investmentCase.analysis.valuation.gap.valuationMethodNotApplicable":
    "Free cash flow yield is not used to value banks, insurers and securities firms.",
  "investmentCase.analysis.valuation.gap.valuationApplicabilityUnknown":
    "The company's industry is not recorded, so Atlas cannot tell whether free cash flow yield applies.",
  "investmentCase.analysis.valuation.gap.currencyMismatch":
    "Free cash flow and share price are reported in different currencies, so no yield is formed.",
  ...
  "investmentCase.analysis.valuation.shareCountExact": "Each earlier market value uses that period's own reported share count.",
  "investmentCase.analysis.valuation.shareCountEquivalent": "Each earlier market value uses that period's own share basis; for some periods a class is priced through filed economic equivalence rather than its own listing.",
  "investmentCase.analysis.valuation.shareCountBounded": "Each earlier market value uses that period's own share basis; for some periods part of it is an evidence-derived interval, and the comparison holds at both ends of that interval.",
  "investmentCase.analysis.valuation.boundaryDistance": "{{percent}} away from classifying as {{classification}}.",
  "investmentCase.analysis.valuation.rangeEdges": "Range ends: FY{{lowYear}} at {{low}} and FY{{highYear}} at {{high}}; next-lowest FY{{secondLowYear}} at {{secondLow}}.",
  "investmentCase.analysis.valuation.corroboration": "{{below}} of {{count}} prior years sit at or below today's yield of {{current}}.",
  "investmentCase.analysis.valuation.dispersion": "Prior-year FCF yields ran {{low}} to {{high}}, median {{median}}.",
  "investmentCase.analysis.valuation.cashFlowVsHistory": "This period's free cash flow is {{versusPrior}} of last year's and {{versusRecent}} of the median of the {{count}} most recent compared years.",
  "investmentCase.analysis.valuation.capitalIntensity": "Capital expenditure is {{current}} of revenue, against a {{median}} median across {{count}} compared years ({{low}} to {{high}}).",
  ...
  "investmentCase.analysis.risk.gap.missingDebt": "Total debt is missing.",
  "investmentCase.analysis.risk.gap.industryUnknown": "The company's industry is unknown.",
  "investmentCase.analysis.risk.gap.staleFinancialStatements": "The latest comparable fiscal year is too old.",
  "investmentCase.analysis.risk.gap.noAlignedPeriod": "Debt and cash flow aren't reported for the same fiscal year.",
  "investmentCase.analysis.risk.gap.missingOperatingCashFlow": "Operating cash flow can't be derived — free cash flow or capital expenditure is missing.",
  ...
  "investmentCase.observations.technicalTransparencyLabel": "Technical transparency — raw observations, evidence, and reasoning records",
  ...
  "investmentCase.header.valuationVsHistoryLabel": "Valuation vs. own history",
  ...
  "investmentCase.hero.why.business_strong_valuation_unknown":
    "Business fundamentals remain strong; today's valuation cannot yet be judged against enough history.",
  "investmentCase.hero.why.business_weak_valuation_unknown":
    "The business has weakened; today's valuation cannot yet be judged against enough history.",
  ...
  "history.analytical.loadOlder": "Load older analyses",
  "history.analytical.loadingOlder": "Loading older analyses…",
  "history.analytical.loadOlderFailed": "Older analyses could not be loaded ({{message}}). The entries above are unaffected.",
  "history.analytical.evidence.notStored": "Detailed valuation evidence was not stored for this analysis.",
  "history.analytical.evidence.yieldAtAnalysis": "FCF yield at the analysis: {{yield}}.",
  "history.analytical.evidence.comparedWith": "Compared with {{count}} earlier fiscal years recorded at the time.",
  "history.analytical.evidence.withheld": "No fiscal years qualified for comparison at the time; Valuation Support was {{support}}.",
  "history.analytical.evidence.singleLowEdge": "FY{{year}} formed the low end of the range. At the analysis, the FCF yield was below every other stored prior year.",
  "history.analytical.evidence.singleHighEdge": "FY{{year}} formed the high end of the range. At the analysis, the FCF yield was above every other stored prior year.",
  "history.analytical.evidence.showDetail": "Valuation evidence at the analysis",
  "history.analytical.evidence.range": "Range ends at the analysis: FY{{lowYear}} at {{low}} and FY{{highYear}} at {{high}}.",
  "history.analytical.evidence.corroboration": "{{below}} of {{count}} recorded prior years sat at or below the yield at the analysis.",
  "history.analytical.evidence.support": "Valuation Support at the analysis: {{support}}.",
  "history.analytical.evidence.methodology": "Method used: {{methodology}}.",
  "history.analytical.evidence.tableCaption": "Fiscal years compared at the analysis",
  "history.analytical.evidence.columnYear": "Fiscal year",
  "history.analytical.evidence.columnYield": "FCF yield",
  "history.analytical.evidence.columnBasis": "Share basis",
  ...
  "investmentCase.whatWouldChange.improvedGrowthEvidence": "Evidence that growth has stabilized or improved",
  "investmentCase.whatWouldChange.improvedCapitalAllocationEvidence": "Evidence of improved capital allocation",
  "investmentCase.whatWouldChange.lowerValuation": "A materially lower valuation",
  "investmentCase.whatWouldChange.noCredibleTriggerIdentified": "Atlas has not identified a specific condition that would change this view.",
  "investmentCase.drivers.heading": "Why Atlas thinks this",
  ...
  "investmentCase.outlook.gap.valuationNotApplicable": "Atlas's FCF-yield valuation does not apply to this type of business, so there is no sensitivity to show.",
  "investmentCase.outlook.notApplicable": "Not applicable",
  "investmentCase.outlook.withheldStatus": "Withheld",
  "investmentCase.outlook.partialRangeNote": "Withheld endpoints are not part of this range (anchor year {{periods}}).",
  ...
  "investmentCase.reasoning.valuation.limited":
    "Today's FCF yield can only be compared with {{count}} earlier fiscal years — too little history for valuation to affect the recommendation.",
  "investmentCase.reasoning.valuation.limitedOne":
    "Today's FCF yield can only be compared with one earlier fiscal year — too little history for valuation to affect the recommendation.",
  "investmentCase.reasoning.valuation.noHistory":
    "Today's FCF yield has no earlier fiscal year to compare with yet, so valuation does not affect the recommendation.",
  "investmentCase.reasoning.valuation.notApplicable": "Free cash flow yield is not used to value this type of business.",
  "investmentCase.reasoning.financialHealth.low":
    "Financial risk is low — debt is small relative to the cash generated by operations.",
  "investmentCase.reasoning.financialHealth.moderate":
    "Financial risk is moderate — debt is noticeable relative to the cash generated by operations; worth monitoring.",
  "investmentCase.reasoning.financialHealth.high": "Financial risk is high and warrants attention.",
  "investmentCase.reasoning.financialHealth.notApplicable": "Atlas's general debt and cash-flow measure is not used for this type of business.",
  ...
  "dailyBrief.agenda.unavailable": "Atlas could not build today's brief. Try refreshing the page.",
  "dailyBrief.scheduledEvents.notTracked": "Atlas does not yet track scheduled company events, so this brief cannot tell you what is coming today.",
  ...
  "discovery.candidates.loading": "Loading the companies Atlas has analysed…",
  "discovery.candidates.empty": "Atlas has no candidates to show. Every company it has analysed is one you already own or already watch.",
  "discovery.candidates.universeOne": "1 company Atlas has analysed that you neither own nor watch.",
  "discovery.candidates.universeOther": "{{count}} companies Atlas has analysed that you neither own nor watch.",
  "discovery.table.companyHeader": "Company",
  "discovery.table.decisionHeader": "Decision support",
  "discovery.table.coverageHeader": "Coverage",
  "discovery.table.fitHeader": "Fit",
  "discovery.table.notAssessed": "Not assessed",
  "discovery.table.rowAriaLabel": "Open the Investment Case for {{ticker}}",
  "discovery.search.heading": "Search for a company",
  "discovery.search.explanation": "Search is not ranked: it looks up any listed company by ticker or name, whether or not Atlas has analysed it.",
  "discovery.search.clear": "Clear",
  "discovery.search.inCandidates": "Analysed — among the candidates above",
  "discovery.card.openingCase": "Opening the Investment Case for {{ticker}}…",
  "discovery.notConcluded.heading": "No conclusion yet",
  "discovery.entrySupported.heading": "Atlas supports a new position",
  "discovery.entrySupported.empty": "None of these companies currently has Atlas's support for a new position.",
  "discovery.notConcluded.explanation": "Atlas has studied these but has not reached a conclusion on entering. Yours to judge.",
  "discovery.notSupported.headingOne": "1 company where Atlas does not support entering",
  "discovery.notSupported.headingOther": "{{count}} companies where Atlas does not support entering",
  "discovery.notSupported.caption": "Companies where Atlas does not support entering",
  ...
  // ---------- portfolio import (link label only; see onboarding.* for the flow) ----------
  ...
  "watchlist.description": "Atlas continuously monitors these companies for you, until you buy or remove them.",
  "watchlist.countOne": "1 company monitored",
  "watchlist.countOther": "{{count}} companies monitored",
  ...
  "watchlist.empty.body": "Add a company for Atlas to start monitoring. Atlas will build an Investment Case for it automatically.",
  "watchlist.empty.cta": "+ Add Your First Company",
  "watchlist.table.companyHeader": "Company",
  "watchlist.table.monitoringSinceHeader": "Monitoring since",
  "watchlist.table.waitingForHeader": "Waiting for",
  ...
  "watchlist.table.notAssessed": "Not assessed",
  ...
  "stance.reason.confidenceVeryLimited": "Atlas has evaluated very few of the dimensions in this analysis.",
  "stance.reason.confidenceLimited": "Atlas has evaluated only a limited part of this analysis.",
  "stance.reason.confidenceModerate": "Atlas has evaluated much, but not all, of this analysis.",
  ...
  "stance.notYetEvaluatedByAtlasLabel": "Atlas does not evaluate this yet, for any company:",
  ...
  "investmentReasoning.heading": "What Atlas sees",
  "investmentReasoning.state.withheld": "Atlas does not yet support a directional recommendation.",
  "investmentReasoning.state.directional": "Atlas conclusion: {{action}}.",
  "investmentReasoning.row.supports": "In favour",
  "investmentReasoning.row.opposes": "Against",
  "investmentReasoning.row.indicatesFor": "Evidence in favour",
  ...
  "investmentReasoning.reason.growthModerate": "Moderate growth",
  "investmentReasoning.reason.growthWeak": "Weak growth",
  "investmentReasoning.reason.capitalAllocationStrong": "Strong capital allocation",
  "investmentReasoning.reason.capitalAllocationModerate": "Moderate capital allocation",
  "investmentReasoning.reason.capitalAllocationWeak": "Weak capital allocation",
  "investmentReasoning.reason.valuationUndervalued": "Undervalued",
  "investmentReasoning.reason.valuationFairlyValued": "Fairly valued",
  "investmentReasoning.reason.valuationExpensive": "Expensive",
  "investmentReasoning.reason.valuationSupported": "Valuation is supported",
  "investmentReasoning.reason.valuationNotSupported": "Valuation is not supported",
  "investmentReasoning.reason.financialRiskElevated": "Elevated financial risk",
  "investmentReasoning.reason.financialRiskNotElevated": "No elevated financial risk",
  "investmentReasoning.engine.growth": "growth",
  "investmentReasoning.engine.capitalAllocation": "capital allocation",
  "investmentReasoning.engine.valuation": "valuation",
  "investmentReasoning.engine.valuationSupport": "valuation support",
  ...
  "investmentReasoning.trigger.improvedCapitalAllocationEvidence": "Better evidence on capital allocation",
  "investmentReasoning.trigger.lowerValuation": "A lower valuation",
  "investmentReasoning.trigger.financialRiskBecomesElevated": "If financial risk becomes elevated",
  "investmentReasoning.trigger.valuationBecomesExpensive": "If the valuation becomes expensive",
  "investmentReasoning.trigger.valuationSupportLost": "If valuation support is lost",
  "investmentReasoning.trigger.growthDeteriorates": "If growth deteriorates",
  "investmentReasoning.trigger.capitalAllocationDeteriorates": "If capital allocation deteriorates",
  "investmentReasoning.trigger.noCredibleTrigger": "No clear trigger identified",
  "investmentReasoning.row.forwardContext": "Forward evidence",
  "investmentReasoning.forward.subject.revenue": "revenue",
  "investmentReasoning.forward.subject.adjustedEbitda": "an EBITDA measure",
  "investmentReasoning.forward.subject.freeCashFlow": "a free-cash-flow measure",
  "investmentReasoning.forward.subject.capitalExpenditure": "capital expenditure",
  "investmentReasoning.forward.subject.managementDefined": " (management's definition)",
  "investmentReasoning.forward.guidance.reaffirmed": "{{horizon}} guidance for {{measure}} unchanged at {{value}}",
  "investmentReasoning.forward.guidance.raised": "{{horizon}} guidance for {{measure}} raised to {{value}} (from {{prior}})",
  "investmentReasoning.forward.guidance.lowered": "{{horizon}} guidance for {{measure}} lowered to {{value}} (from {{prior}})",
  "investmentReasoning.forward.guidance.priorUnknown": "a prior figure its sources state differently",
  "investmentReasoning.forward.guidance.revisionCount": "{{count}} verified revisions",
  "investmentReasoning.forward.horizon.fiscalYear": "Fiscal {{year}}",
  "investmentReasoning.forward.horizon.calendarYear": "Calendar {{year}}",
  "investmentReasoning.forward.horizon.year": "{{year}}",
  "investmentReasoning.forward.volume.single": "Contracted customer volume: {{customer}} — {{details}}",
  "investmentReasoning.forward.volume.multiple": "Contracted customer volume naming {{names}} in {{count}} source observations ({{periods}}) — one agreement can appear in more than one",
  "investmentReasoning.forward.volume.and": " and ",
  "investmentReasoning.forward.volume.term": ", {{years}}-year term",
  "investmentReasoning.forward.volume.deliveryFrom": ", deliveries from {{years}}",
  "investmentReasoning.forward.volume.unnamedCustomer": "an unnamed customer",
  "investmentReasoning.forward.volume.statedTerms": "; stated terms: {{terms}} years",
  "investmentReasoning.forward.unknown.allEconomics": "Contract price, and contribution to revenue, earnings and cash flow, not established",
  "investmentReasoning.forward.unknown.price": "Contract price not established",
  "investmentReasoning.forward.unknown.revenueContribution": "Revenue contribution not established",
  "investmentReasoning.forward.unknown.earningsContribution": "Earnings contribution not established",
  "investmentReasoning.forward.unknown.cashFlowContribution": "Cash-flow contribution not established",
  "investmentReasoning.riskBasis.debtBurdenHigh": "Elevated financial risk: total debt is {{multiple}} the cash generated by operations ({{period}}).",
  "investmentReasoning.riskBasis.operatingCashFlowNegative": "Elevated financial risk: cash flow from operations was negative ({{period}}: {{value}}) — operations consumed cash.",
  "investmentReasoning.riskBasis.operatingCashFlowZero": "Elevated financial risk: operations generated no cash ({{period}}).",
  ...
  "investmentReasoning.riskBasis.level.notEvaluated": "not evaluated",
  "investmentReasoning.riskBasis.level.insufficientInput": "could not be assessed",
  "investmentReasoning.riskBasis.level.notApplicable": "not assessed for this type of business",
  ...
  "investmentReasoning.valuationBasis.belowAllYears": "today's FCF yield ({{current}}) is lower than in all {{count}} earlier fiscal years of the company's own history (median {{median}}) — not a comparison with peers.",
  "investmentReasoning.valuationBasis.belowMedianYears": "today's FCF yield ({{current}}) is below the company's own median across {{count}} earlier fiscal years ({{median}}) — not a comparison with peers.",
  "investmentReasoning.valuationBasis.shareBasis": "Earlier market values use each period's own share basis, not today's.",
  "investmentReasoning.valuationEvidence.limited": "Limited valuation history: today's FCF yield ({{current}}) can only be compared with {{count}} earlier fiscal years — too few for valuation to affect the recommendation.",
  "investmentReasoning.valuationEvidence.limitedOne": "Limited valuation history: today's FCF yield ({{current}}) can only be compared with one earlier fiscal year — too few for valuation to affect the recommendation.",
  "investmentReasoning.valuationEvidence.none": "No valuation history yet: today's FCF yield ({{current}}) has no earlier fiscal year to compare with, so valuation does not affect the recommendation.",
  "investmentReasoning.valuationEvidence.notApplicable": "Valuation: free cash flow yield is not used to value banks, insurers and securities firms.",
