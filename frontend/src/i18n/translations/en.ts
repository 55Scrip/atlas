...
export const en = {
  ...
  "investmentCase.analysis.companyOverview.empty": "Atlas has not yet automatically identified this company. Enrichment may still be in progress or unavailable for this ticker.",
  "investmentCase.analysis.financials.heading": "Financials",
  "investmentCase.analysis.financials.periodLabel": "Fiscal period ending {{date}}",
  ...
  "investmentCase.analysis.financials.empty": "Atlas has not yet automatically fetched financial data for this company.",
