...
export const en = {
  ...
  "investmentCase.analysis.valuationScenarios.notYet": "Scenario-based valuation is not yet supported. Atlas currently evaluates valuation using FCF yield relative to history only.",
