...
export const en = {
  ...
  "dataFreshness.status.waitingForNewData": "No new data detected.",
  "dataFreshness.status.waitingForAnalysis": "New data detected. Waiting for analysis.",
  "dataFreshness.status.monitoringFailed": "Refresh failed.",
  "dataFreshness.status.noDataSource": "No data source available.",
  ...
  "coverage.dimension.insufficientEvidence": "Insufficient evidence",
  ...
  "coverage.panel.heading": "Analysis Coverage",
  "coverage.panel.overallCoverageLabel": "Overall coverage",
  ...
  "coverage.badge.label": "Coverage",
  "coverage.portfolio.columnLabel": "Coverage",
  "coverage.portfolio.sortLabel": "Coverage",
  "coverage.discovery.badgeLabel": "Analysis coverage",
  ...
  "evidenceTimeline.category.coverageChanged": "Coverage",
  ...
  "monitoring.freshness.upToDate": "Based on monitoring completed {{time}}.",
  "monitoring.freshness.pending": "Based on monitoring completed {{time}}. Newer information may not be reflected yet.",
  "monitoring.freshness.running": "Atlas is running a monitoring update now.",
  "monitoring.freshness.failed": "Atlas's last monitoring run did not complete for every company — some information may be outdated.",
  "monitoring.freshness.unknown": "Atlas has not yet completed a monitoring run.",
  "monitoring.freshnessSummary.line": "{{waiting}} waiting for analysis, {{current}} with no new data, {{attention}} need attention.",

  "monitoring.changeFeed.heading": "Monitoring",
  "monitoring.changeFeed.empty": "Atlas has not found any changes to report for your companies.",
  "monitoring.changeFeed.unavailable": "Monitoring changes are not available right now.",
  ...
  "decisionReadiness.blocker.monitoringFailed": "The last monitoring check did not complete.",
  ...
  "decisionReadiness.reason.monitoringCurrent": "Monitoring is up to date.",
  ...
  "decisionPath.progressKind.coverage": "Coverage",
  ...
  "portfolioDecision.category.requiresReview": "Requires review",
