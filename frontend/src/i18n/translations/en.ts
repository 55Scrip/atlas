...
export const en = {
  ...
  "dailyBriefAgenda.summary.attentionCountOther": "{{count}} things need your attention today.",
  "dailyBriefAgenda.summary.watchlistOpportunityCountOne": "1 watchlist opportunity worth a look.",
  ...
  "discovery.search.heading": "Search / Review a Company",
  ...
  "discovery.candidatesForPortfolio.heading": "Candidates for Your Portfolio",
  "discovery.candidatesForPortfolio.tierCountOne": "{{count}} candidate",
  "discovery.candidatesForPortfolio.tierCountOther": "{{count}} candidates",
  "discovery.candidatesForPortfolio.loadError": "Atlas could not load your ranked candidates. Try refreshing the page.",
  "discovery.watchlistCandidates.heading": "Watchlist Candidates",
  "discovery.watchlistCandidates.empty": "Your Watchlist is empty. Search above to add a company.",
  "discovery.watchlistCandidates.loadError": "Atlas could not load your Watchlist. Try refreshing the page.",
  "discovery.compareSection.heading": "Compare",
  "discovery.compareSection.explanation": "Compare two candidates, or a candidate against an existing holding, using the same Portfolio Fit Engine used everywhere else in Atlas.",
  "discovery.compareSection.openButton": "Open Compare →",
  "discovery.recentActivity.heading": "Recent Watchlist Activity",
  "discovery.recentActivity.empty": "No recent activity recorded for your Watchlist.",
  "discovery.recentActivity.loadError": "Atlas could not load recent activity. Try refreshing the page.",
  ...
  "discovery.card.tension.stanceNegativeFitPositive": "This reflects portfolio fit only — Atlas separately flagged a concern in the business itself.",
  "discovery.card.tension.stancePositiveFitNegative": "Atlas's view on this company has strengthened, but it would fit your portfolio poorly.",
