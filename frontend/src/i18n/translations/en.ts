...
export const en = {
  ...
  "investmentReasoning.riskBasis.financial": "Basis for elevated financial risk: {{basis}}.",
  "investmentReasoning.riskBasis.debtIncreased": "total debt rose from each evaluated period to the next ({{series}})",
  "investmentReasoning.riskBasis.cashNegative": "the most recent free cash flow was negative ({{figure}})",
  "investmentReasoning.riskBasis.capitalAllocationWeak": "capital allocation is assessed as weak",
  "investmentReasoning.riskBasis.alsoValuation": "Valuation risk is also assessed as high.",
  "investmentReasoning.riskBasis.scope": "The assessment reads reported historical amounts — not leverage ratios, interest coverage, liquidity or credit ratings.",
  "investmentReasoning.riskBasis.valuationOnly": "Basis for elevated financial risk: valuation risk is assessed as high — the valuation is high relative to the company's own history. Financial risk itself is assessed as {{level}}.",
  "investmentReasoning.riskBasis.level.notEvaluated": "not evaluated",
  "investmentReasoning.riskBasis.level.insufficientInput": "not possible to assess",
