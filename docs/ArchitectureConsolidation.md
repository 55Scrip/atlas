# Architecture Consolidation (Sprint 44, updated Sprint 67, reviewed Sprint 71, reviewed Sprint 135)
...
**Sprint 135 (2026-07-02):** `atlas/analysis/portfolio.py` deleted. `Portfolio`, `PortfolioPosition`, `_position_from_mapping`, `_normalize_weight` moved into `atlas/adapters/portfolio.py`. All 12 production import sites updated (3 runtime callers: `atlas/cli/main.py`, `atlas/portfolio_review/engine.py`, `atlas/adapters/portfolio.py`; 8 annotation-only callers behind `TYPE_CHECKING`; 1 re-export removed from `atlas/analysis/__init__.py`). `atlas/analysis/__init__.py` no longer exports `Portfolio` or `PortfolioPosition`. Sprint 135 guardrail block added to `test_portfolio_analyze_deprecation.py` (4 new tests). Stale "is importable" assertions flipped in 5 test files (`test_portfolio_analyze_deprecation.py`, `test_decision_engine.py`, `test_home_engine.py`, `test_monitoring_engine.py`, `test_suitability_engine.py`). `test_portfolio_intelligence_capability.py` updated. `atlas/analysis/` now clean — only `engine.py`, `explanation.py`, `report.py`, `scores.py`, `providers.py` remain. 1361 tests passing (3 skipped). Demo passed. Release verification green.
