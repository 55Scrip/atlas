# Architecture Consolidation (Sprint 44, updated Sprint 67, reviewed Sprint 71, reviewed Sprint 138, reviewed Sprint 139, reviewed Sprint 140, reviewed Sprint 142, reviewed Sprint 143, reviewed Sprint 144, reviewed Sprint 145, reviewed Sprint 146, reviewed Sprint 147, reviewed Sprint 148, reviewed Sprint 149, reviewed Sprint 150, reviewed Sprint 151, reviewed Sprint 152, reviewed Sprint 153, reviewed Sprint 154, reviewed Sprint 155, reviewed Sprint 156, reviewed Sprint 157, reviewed Sprint 158, reviewed Sprint 159, reviewed Sprint 160, reviewed Sprint 161, reviewed Sprint 162, reviewed Sprint 163, reviewed Sprint 164, reviewed Sprint 165, reviewed Sprint 166, reviewed Sprint 167, reviewed Sprint 168, reviewed Sprint 169, reviewed Sprint 170, reviewed Sprint 171, reviewed Sprint 172, reviewed Sprint 173, reviewed Sprint 174, reviewed Sprint 175, reviewed Sprint 176, reviewed Sprint 177, reviewed Sprint 178, reviewed Sprint 179, reviewed Sprint 180, reviewed Sprint 181, reviewed Sprint 182, reviewed Sprint 183, reviewed Sprint 184, reviewed Sprint 185, reviewed Sprint 186, reviewed Sprint 187, reviewed Sprint 188, reviewed Sprint 189, reviewed Sprint 190, reviewed Sprint 191, reviewed Sprint 192, reviewed Sprint 193, reviewed Sprint 194, reviewed Sprint 195, reviewed Sprint 196, reviewed Sprint 197, reviewed Sprint 198, reviewed Sprint 199, reviewed Sprint 200, reviewed Sprint 201, reviewed Sprint 202, reviewed Sprint 203, reviewed Sprint 204, reviewed Sprint 205, reviewed Sprint 206, reviewed Sprint 207, reviewed Sprint 208, reviewed Sprint 209, reviewed Sprint 210, reviewed Sprint 211, reviewed Sprint 212, reviewed Sprint 213, reviewed Sprint 214, reviewed Sprint 215, reviewed Sprint 216, reviewed Sprint 217, reviewed Sprint 218, reviewed Sprint 219, reviewed Sprint 220)
...
**Sprint 133 (2026-07-02):** `CompanyPortfolioProfile` deleted from `atlas/analysis/portfolio.py`. `CompanyDataProvider.get_portfolio_profile()` return type migrated from `CompanyPortfolioProfile` to `PortfolioFitInput` across all 3 provider files. `portfolio_fit_input_from_profile` in `atlas/adapters/portfolio.py` changed to identity function (`PortfolioFitInput → PortfolioFitInput`) — 4 engine callers (conversation, dashboard, intelligence, decision) left untouched (Option A). `portfolio.py` reduced from 69 to 67 lines — now contains only `Portfolio`, `PortfolioPosition`, and 2 private helpers. Sprint 133 guardrail block added to `test_portfolio_analyze_deprecation.py`. 1352 tests passing (3 skipped). Demo passed. Release verification green.

**Sprint 134 (2026-07-02):** Planning sprint. Full caller audit of remaining `Portfolio` and `PortfolioPosition`. 12 production import sites documented (3 runtime + 1 re-export + 8 annotation-only). Sprint 135 target selected: "lift and shift" — move `Portfolio`, `PortfolioPosition`, and 2 private helpers into `atlas/adapters/portfolio.py`, update all callers, delete `atlas/analysis/portfolio.py` in a single sprint. Destination rationale: adapter is already the legacy compatibility boundary; making it self-contained is the lowest-risk move. Sprint 134 guardrail tests added. 1352 tests passing (3 skipped). Demo passed. Release verification green.

**Sprint 135 (2026-07-02):** `atlas/analysis/portfolio.py` deleted. `Portfolio`, `PortfolioPosition`, `_position_from_mapping`, `_normalize_weight` moved into `atlas/adapters/portfolio.py`. All 12 production import sites updated (3 runtime callers: `atlas/cli/main.py`, `atlas/portfolio_review/engine.py`, `atlas/adapters/portfolio.py`; 8 annotation-only callers behind `TYPE_CHECKING`; 1 re-export removed from `atlas/analysis/__init__.py`). `atlas/analysis/__init__.py` no longer exports `Portfolio` or `PortfolioPosition`. Sprint 135 guardrail block added to `test_portfolio_analyze_deprecation.py` (4 new tests). Stale "is importable" assertions flipped in 5 test files. `test_portfolio_intelligence_capability.py` updated. 1361 tests passing (3 skipped). Demo passed. Release verification green.

**Sprint 138 (2026-07-02):** Analysis package checkpoint. 13 modules audited in `atlas/analysis/`. Classified: `engine.py` (foundational, 229 lines, 11 production callers — leave for last); `company_analysis.py`, `explanation.py`, `report.py` (active); `scores.py` (shared utility, 10 production callers — do not move); 7 identical-pattern placeholder submodules (`growth`, `macro`, `moat`, `quality`, `sentiment`, `technicals`, `valuation`, each 18 lines) imported exclusively by `company_analysis.py` — Sprint 139 consolidation target. `atlas/analysis/__init__.py` exports confirmed clean (12 active exports, no stale portfolio symbols). All 5 deleted modules (`portfolio`, `scoring`, `watchlist`, `comparison`, `memory`) confirmed not importable. No runtime changes. 1359 tests passing (3 skipped). Demo passed. RC2 green.

**Sprint 137 (2026-07-02):** `portfolio_fit_input_from_profile` identity adapter deleted from `atlas/adapters/portfolio.py`. Four engine callers (conversation, dashboard, intelligence, decision) updated to call `provider.get_portfolio_profile()` directly. `atlas/adapters/portfolio.py` now contains only: `Portfolio`, `PortfolioPosition`, `legacy_portfolio_to_domain_portfolio`, and 2 private helpers (`_position_from_mapping`, `_normalize_weight`). 9 test functions updated (6 deleted behavior tests for the identity function, 4 engine source-pattern assertions flipped, 2 sprint 133/134 identity tests flipped to deletion guardrails, 5 Sprint 137 guardrails added in `test_portfolio_adapter.py`). 1359 tests passing (3 skipped). Demo passed. Release verification green. Portfolio migration now fully resolved — no further portfolio adapter cleanup pending.

**Sprint 227 (2026-07-04): Snapshot Draft confirmation workflow defined.** New document `docs/SnapshotDraftConfirmationWorkflow.md`. Defines confirmation principles, state meanings, exportability rule, review checklist, blocking rules, field correction model, future CLI shapes, export dependency, audit/traceability expectations, and safety boundary. No runtime changes. No new modules. 57 new tests. 2384 tests passing (3 skipped).

**Sprint 226 (2026-07-04): End-to-end Snapshot conversion loop validated.** No code changes. Three confirmed `research_notes_snapshot` drafts (ASML, XYL, NOVO) validated, exported, and consumed by Weekly Review. Two additional confirmed draft example files added (`research_notes_snapshot_xyl_confirmed.json`, `research_notes_snapshot_novo_confirmed.json`). Trial findings documented in `docs/SnapshotResearchNotesTrialFindings.md`. 2327 tests passing (3 skipped).

**Sprint 225 (2026-07-04): Snapshot Draft research notes export added.** New `atlas/snapshot_input/export.py` with `export_research_notes`, `_resolve_ticker`, `_build_research_notes_markdown`, `ResearchNotesExportResult`. `atlas/snapshot_input/render.py` extended with `render_research_notes_export_success` and `render_research_notes_export_blocked`. `atlas/snapshot_input/__init__.py` updated. `atlas/cli/main.py` extended with `export-research-notes` sub-command. No portfolio/watchlist/journal/company facts writes. No provider imports. No network imports. 2327 tests passing (3 skipped).

**Sprint 224 (2026-07-04): Snapshot Draft CLI validation added.** New `atlas/snapshot_input/render.py` with `render_snapshot_draft_validation` and `render_snapshot_draft_validation_error`. `atlas/snapshot_input/__init__.py` updated to export render functions. `atlas/cli/main.py` extended with `snapshot_app` Typer sub-group and `snapshot validate` command. No file writing. No provider imports. No network imports. No runtime changes to Weekly Review. 2275 tests passing (3 skipped).

**Sprint 223 (2026-07-04): Snapshot Input package created.** New `atlas/snapshot_input/` package with `schema.py`. `SnapshotType`, `SnapshotConfirmationStatus`, `SnapshotConfidence`, `SnapshotDraft`, and file/serialization helpers. No provider imports. No network imports. No runtime behavior changes to any existing module. Weekly Review unchanged. 2231 tests passing (3 skipped).

**Sprint 222 (2026-07-04): Research notes input added.** `WeeklyReviewResearchNote` dataclass added to `atlas/weekly_review/inputs.py`. `WeeklyReviewInputPaths.research_notes_dir` field added. `_parse_research_notes` and `_load_research_note` helpers added. `render.py` updated for Sections 1, 8, 9, 10, and Input Status. `atlas/cli/main.py` extended with `--research-notes`. No provider imports. No network imports. No runtime behavior changes outside weekly_review package. 2159 tests passing (3 skipped).

**Sprint 221 (2026-07-04): Snapshot Input workflow specified.** Documentation-only sprint. New document `docs/AtlasSnapshotInputWorkflow.md` specifies the future Snapshot / Screenshot Input workflow including snapshot types, classification contract, draft contract, confirmation workflow, accuracy guardrails, privacy boundary, and Weekly Review mapping. No runtime behavior changed. No new modules added. Architecture boundary unchanged. 2078 tests passing (3 skipped).

**Sprint 136 (2026-07-02):** Post-portfolio migration checkpoint. Zero active production imports of `atlas.analysis.portfolio` confirmed via AST scan. Adapter boundary verified self-contained (no CLI/provider/deleted-module imports). `atlas/analysis/__init__.py` confirmed clean (no Portfolio/PortfolioPosition exports). `atlas/analysis/` inventory updated: 13 active modules remain — `engine.py` (foundational, 229 lines), `company_analysis.py` (45 lines, aggregates 7 placeholder submodules), `explanation.py` (198 lines), `report.py` (38 lines), `scores.py` (2 lines), and 7 placeholder submodules (`growth.py`, `macro.py`, `moat.py`, `quality.py`, `sentiment.py`, `technicals.py`, `valuation.py`, each 18 lines). `PORTFOLIO_ENGINE_CALLERS` test updated to assert empty list. Stale deprecations.py tracking string updated. Sprint 136 guardrail block (4 tests) added. 1365 tests passing (3 skipped). Demo passed. Release verification green. Sprint 137 target: remove `portfolio_fit_input_from_profile` identity adapter from 4 engine callers.
