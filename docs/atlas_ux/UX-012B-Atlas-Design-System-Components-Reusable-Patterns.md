...
*(Boundary clarification refreshed per the Atlas UX Governance Resolution Sprint, 2026-08-03, superseding without erasing the 2026-08-02 Targeted Correction below: per `UX-000-Atlas-UX-Doctrine.md` UXD-R-071 item 5 (as annotated by the same sprint), Portfolio now possesses formal Product Architecture treatment at `APS-006`. This remains a UX presentation artifact — Portfolio's own Product-layer identity, ownership, and responsibility are governed exclusively by `APS-006`, not by this component's presentation of it. This entry SHALL NOT be read as extending, narrowing, or restating `APS-006`'s own Portfolio definition. Prior text (2026-08-02): "this remains a UX presentation artifact whose complete Product-layer correspondence is open pending future Investment Case / Portfolio Product Architecture treatment. This entry SHALL NOT be read as establishing Portfolio as an independent Product Concept.")*
