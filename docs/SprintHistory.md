# Atlas Sprint History

This document preserves the historical sprint notes recorded during Atlas
development (Sprints 37–72). It is moved here from `README.md` to keep the
developer guide concise.

These notes are historical context. They document what was added when.
The current authoritative state is described in
