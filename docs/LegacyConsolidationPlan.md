...
**Updated:** 2026-07-03 (Sprint 161)  
**Status:** `atlas/analysis/` CLOSED Sprint 141. `atlas/decision/` CLOSED Sprint 144. Provider boundary CLOSED Sprint 146. Portfolio boundary CLOSED Sprint 148. Evidence package CLOSED Sprint 150. Reasoning package CLOSED Sprint 153. Risk package CLOSED Sprint 155. Principles package CLOSED Sprint 158. Comparison package CLOSED Sprint 160. Home package ACTIVE (Sprint 161 audit complete — no cleanup warranted; Sprint 162 recommended: close home track). See `docs/HomeCleanupPlan.md`.
