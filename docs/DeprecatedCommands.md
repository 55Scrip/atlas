...
| **Engine blockers** | `WatchlistEngine` is still imported and instantiated by `atlas/intelligence` and `atlas/conversation` (Sprint 95 state). Engine deletion deferred until both callers are retired. |
