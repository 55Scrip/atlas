...
**Status:** DEFINED — product specification complete. Data model specified in Sprint 275. Schema dataclasses implemented in Sprint 276. Example fixtures added in Sprint 277. Read-only validation CLI added in Sprint 278. Read-only summary renderer added in Sprint 279.
